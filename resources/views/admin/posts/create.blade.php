         ...
         <div class="panel-body">
            <form  action="{{ route('admin.posts.store') }}" method="post"  enctype="multipart/form-data">
               ...
               <div class="form-group required">
                  ...
                  <input class="form-control" type="text"  name="title" id="title" value="{{ old('title') }}" placeholder="Post Title"  autocomplete="Off" tabindex="1" minlength="2"  >
               ...
               <div class="form-group required">
                  ...
                  <input type="file" id="input-file-now" class="dropify" data-height="100" name="image"  />
                  @if ($errors->has('image')) <span class="text-danger">{{ $errors->first('image') }} @endif
               </div>
               <div class="form-group ">
                  <label class="control-label ">Post Description </label>
                  <textarea class="form-control wysihtml1" rows="5" name="description"></textarea>  
