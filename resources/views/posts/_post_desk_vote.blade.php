...
<div class="row" style="text-align: center;">
   ...
   @if(isset(Auth::guard('web')->user()->id)) 
      ...
      <div class="col-2 col-md-2">
    <button type="button" class="btn btn-outline-warning no-radius btn-block" id="cbox" data-toggle="tooltip" data-placement="top" title="Copy Link" >
     <a  id="cplink" style=""   onclick="copyToClipboard('#copylink')"><i class="fa fa-link pr-1"></i>  </a>
   ...
   <div class="row">
     ...
     {!! Share::page( \Request::fullUrl(),'', ['class' => 'btn btn-fb btn-block','title' => 'Share with facebook'], '<span class="list-unstyled">', '</span> ')->facebook() !!}
   </div>
   <div class="col-4 col-md-4">
   ...
   <div class="col-4 col-md-4">
    {!! Share::page(\Request::fullUrl(),$post->title, ['class' => 'btn btn-block btn-reddit','title' => 'Share with Reddit'], '<span class="list-unstyled">', '</span> ')->reddit() !!}
   </div>
...
<style type="text/css">
  .udbox{
    padding: .375rem .9rem .375rem .5rem;
