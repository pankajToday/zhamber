...
<div class="row" style="background: #333;margin:0px;padding:15px 0px 0px 0px;text-align: center;">
...
@if(_chkVoted($post->id,'down') == 'Y')
   ...
   <div class="col-3 col-md-4">
    ...
    <div class="col-3 col-md-4">
    <button type="button" class="btn btn-outline-light no-radius btn-block" data-toggle="collapse" href="#shareLink" role="button" aria-expanded="false" aria-controls="shareLink">
